...
@freezed
abstract class TeacherStatusListState with _$TeacherStatusListState {
  const factory TeacherStatusListState({
    @Default(false) bool isLoading,

    @Default(false) bool isFilterLoading,

    @Default(StatusQuery<Teacher, TeacherRosterStatus>())
    StatusQuery<Teacher, TeacherRosterStatus> query,

    @Default(TeacherStatusList()) TeacherStatusList teacherStatusList,
