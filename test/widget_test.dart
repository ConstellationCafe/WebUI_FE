...
void main() {
  group('loading widgets', () {
    testWidgets(
      'ButtonLoading renders a compact white progress indicator',
          (tester) async {
    ...
    testWidgets(
      'PageLoading expands and centers its progress indicator',
          (tester) async {
        await tester.pumpWidget(
          const MaterialApp(
            home: Scaffold(
  ...
  testWidgets(
    'CustomPadding preserves its child and applies padding',
        (tester) async {
  ...
  testWidgets(
    'SaveResultBar creates an error snackbar with an action',
        (tester) async {
  ...
  testWidgets(
    'loading snackbar remains visible for a long duration',
        (tester) async {
